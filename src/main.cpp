...
HallSensor sensor = HallSensor(2, 4, 7, 10);
...
PciListenerImp listenerIndexB(sensor.pinB, doB);
PciListenerImp listenerIndexC(sensor.pinC, doC);
...
void setup() {
  ...
  // software interrupts
  PciManager.registerListener(&listenerIndexB);
  PciManager.registerListener(&listenerIndexC);
